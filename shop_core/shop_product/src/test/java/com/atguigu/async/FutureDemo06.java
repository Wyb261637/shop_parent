...
public class FutureDemo06 {
    ...
    public static void supplyAsync() throws Exception {
      CompletableFuture<String> supply  = CompletableFuture.supplyAsync(new Supplier<String>() {
        ...
        CompletableFuture<String> thenApply1 = supply.thenApplyAsync(new Function<String, String>() {
            @Override
        ...
        CompletableFuture<String> thenApply2= supply.thenApplyAsync(new Function<String, String>() {
            @Override
            public String apply(String acceptVal) {
